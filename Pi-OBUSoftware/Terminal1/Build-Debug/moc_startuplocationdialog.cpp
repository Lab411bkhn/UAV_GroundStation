...
void StartupLocationDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData StartupLocationDialog::staticMetaObjectExtraData = {
...
const QMetaObject StartupLocationDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_StartupLocationDialog,
      qt_meta_data_StartupLocationDialog, &staticMetaObjectExtraData }
};
